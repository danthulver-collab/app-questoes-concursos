...
const EDITOR_ROOT_ID = "website-editor-root";
const BADGE_ID = "website-editor__badge";
function Badge() {
  const [isVisible, setIsVisible] = reactExports.useState(true);
  const [isHovered, setIsHovered] = reactExports.useState(false);
  const [isCloseHovered, setIsCloseHovered] = reactExports.useState(false);
  const handleMouseEnter = reactExports.useCallback(() => setIsHovered(true), []);
  const handleMouseLeave = reactExports.useCallback(() => setIsHovered(false), []);
  const handleCloseMouseEnter = reactExports.useCallback(() => setIsCloseHovered(true), []);
  const handleCloseMouseLeave = reactExports.useCallback(() => setIsCloseHovered(false), []);
  const handleClick = reactExports.useCallback((event) => {
    event.preventDefault();
  }, []);
  const handleCloseClick = reactExports.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
    setIsVisible(false);
    window.dispatchEvent(new CustomEvent("website-editor:close"));
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      style: {
        ...
        boxShadow: isHovered ? "var(--editor-shadow-md)" : "var(--editor-shadow-sm)"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              ...
              border: "none",
              borderRadius: "9999px",
              backgroundColor: isCloseHovered ? "var(--editor-surface-strong)" : "transparent",
              color: isCloseHovered ? "var(--editor-text-strong)" : "var(--editor-text-muted)",
...
const THEME_STYLE_ID = "runable-editor-theme";
...
#${EDITOR_ROOT_ID}[data-theme="light"] {
  color-scheme: light;
...
`;
const normalizeEditorTheme = (theme) => theme === "light" ? "light" : "dark";
const getInitialEditorTheme = () => {
  if (typeof window === "undefined") return "dark";
  return normalizeEditorTheme(window.__RUNABLE_CONFIG__?.theme);
};
const ensureEditorThemeStyles = () => {
  if (typeof document === "undefined") return;
  if (document.getElementById(THEME_STYLE_ID)) return;
  const style = document.createElement("style");
  style.id = THEME_STYLE_ID;
  style.textContent = editorThemeStyles;
...
container.id = EDITOR_ROOT_ID;
document.body.appendChild(container);
ensureEditorThemeStyles();
applyEditorTheme(getInitialEditorTheme());
clientExports.createRoot(container).render(/* @__PURE__ */ jsxRuntimeExports.jsx(Badge, {}));
