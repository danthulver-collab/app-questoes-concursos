        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="glass-card rounded-2xl p-6 border border-white/10 bg-gradient-to-br from-orange-500/10 to-amber-500/10">
              ...
              <a 
                href="/questoes"
                className="block text-center px-4 py-3 bg-gradient-to-r from-orange-500 to-amber-500 rounded-xl font-bold text-white hover:scale-105 transition-transform"
              >
                Responder Questões
              </a>
            </div>
